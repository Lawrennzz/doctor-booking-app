...
class MainViewModel() : ViewModel() {
    ...
    private val _filteredDoctors = MutableLiveData<MutableList<DoctorsModel>>()

    val category: LiveData<MutableList<CategoryModel>> = _category
    val doctors: LiveData<MutableList<DoctorsModel>> = _doctors
    val filteredDoctors: LiveData<MutableList<DoctorsModel>> = _filteredDoctors
    ...
    fun filterDoctors(query: String) {
        val filtered = if (query.isEmpty()) {
            ...
            allDoctors.filter {
                ...
                it.Special?.contains(query, ignoreCase = true) == true
            }.toMutableList()
        }
